...
/**
 * CttStaticdataDocumenttypesSearch represents the model behind the search form about `app\models\CttStaticdataDocumenttypes`.
 */
class CttStaticdataDocumenttypesSearch extends CttStaticdataDocumenttypes
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = CttStaticdataDocumenttypes::find();
