...
$this->title = Yii::t('app', 'Ctt Staticdata Authortypes');
      ...
      <?= GridView::widget([
        ...
        'panel'=>[
            ...
            'before' => '<div class="clearfix"></div>'
                        ...
                        .Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('app/ctt_staticdata_authortype', 'Create Ctt Staticdata Docsources'),
                                ['lang-list'],
