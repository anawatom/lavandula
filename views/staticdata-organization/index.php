...
$this->title = Yii::t('app/ctt_staticdata_organization', 'Ctt Staticdata Organizations');
     ...
     <?= GridView::widget([
        ...
        'panel'=>[
            ...
            'before' => '<div class="clearfix"></div>'
                        ...
                        .Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('app/ctt_staticdata_organization', 'Create Ctt Staticdata Organizations'),
                                ['lang-list'],
