...
$this->title = Yii::t('app/ctt_staticdata_subjectarea_class', 'Ctt Staticdata Subjectarea Classes');
   ...
   <?= GridView::widget([
        ...
        'panel'=>[
            ...
            'before' => '<div class="clearfix"></div>'
                        ...
                        .Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('app/ctt_staticdata_subjectarea_class', 'Create Ctt Staticdata Subjectarea Classes'),
                                ['lang-list'],
