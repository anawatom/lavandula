...
$this->title = Yii::t('app/ctt_staticdata_subjectarea', 'Ctt Staticdata Subjectareas');
   ...
   <?= GridView::widget([
        ...
        'panel'=>[
            ...
            'before' => '<div class="clearfix"></div>'
                        ...
                        .Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('app/ctt_staticdata_subjectarea', 'Create Ctt Staticdata Subjectareas'),
                                ['lang-list'],
